...
Allows registering and discovering backbones, encoders, decoders, losses,
datasets, and other components by name — so users can swap them via config
without modifying source code.

Usage:
    from flashocr.registry import BACKBONES, ENCODERS, DECODERS
...
DOCUMENT_PROCESSORS = Registry("document_processors")
