"""
Checkpoint utilities for saving and loading OCR models.
"""
...
def save_checkpoint(
    ...
    elif hasattr(model, "charset_size"):
        checkpoint["config"] = {
            "charset_size": getattr(model, "charset_size", 96),
            "input_size": getattr(model, "input_size", (32, 128)),
            "backbone_size": getattr(model, "backbone_size", "small"),
...
def load_checkpoint(
    ...
    if optimizer is not None and "optimizer_state_dict" in checkpoint:
        try:
            ...
            print(
                f"  Optimizer state skipped (architecture mismatch: {e}). "
